/*!
 * Chirpy v6.1.0 (https://github.com/gogg772/goggi772.github.io/)
 * © 2019 Cotes Chung
 * MIT Licensed
 */
...
(function () {
  ...
  function categoryCollapse() {
    ...
    collapse.on('hide.bs.collapse', function () {
      /* Bootstrap collapse events. */var parentId = parentPrefix + $(this).attr('id').substring(childPrefix.length);
      if (parentId) {
